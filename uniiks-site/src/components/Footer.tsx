...
export default function Footer() {
  return (
    <footer className="bg-[var(--color-primary-dark)] text-white">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[var(--color-secondary)] transition-colors"
                aria-label="Facebook"
              >
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-white/70 hover:text-[var(--color-accent)] text-sm transition-colors flex items-center gap-2"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 text-[var(--color-accent)]" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {services.map((service) => (
                <li key={service} className="text-white/70 text-sm flex items-start gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[var(--color-accent)] shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div>
            ...
            <address className="not-italic space-y-4 text-sm text-white/70">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:admin@uniikscare.com" className="hover:text-[var(--color-accent)] transition-colors">admin@uniikscare.com</a>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div>
                  ...
                  <p className="text-[var(--color-accent)]">24/7 Emergency Line</p>
                </div>
              </div>
            </address>
          </div>
      ...
      {/* Compliance Bar */}
      <div className="border-t border-white/10 bg-[var(--color-primary-dark)]">
